...
const BudgetDetails: FC<Props> = ({ openPopupHandle, budget, setMode }) => {
  ...
  return (
    <>
      <div
        style={{ background: budget.categories[0].color }}
      ...
      <div className={"popup__fields"}>
        <div>
          <Amount sum={budget.limit + budget.spent} />
        </div>
        <div className={"popup__row popup__row__half"}>
          <span>Budget:</span>
        ...
        <div className={"popup__row popup__row__align-start"}>
          <div className={"budgets-category-list-label"}>
            Categories:
