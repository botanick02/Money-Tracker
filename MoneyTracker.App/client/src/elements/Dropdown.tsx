...
const Dropdown: FC<SelectPropsType> = ({
  selectHandler,
  options,
  title,
  defaultOptionIndex,
  ...
  useEffect(() => {
    if (defaultOptionIndex) setSelectedOptionId(defaultOptionIndex);
  }, [defaultOptionIndex]);
        ...
        {options[selectedOptionId].icon ? (
          <span>
            <div className={"dropdown-icon"}>
              <img
                src={options[selectedOptionId].icon}
                alt="https://picsum.photos/52"
              />
            </div>
